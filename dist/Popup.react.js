    ...
    value: function render() {
      ...
      if (this.state.visible) {
        ...
        if (this.props.closeBtn) {
          closeBtn = /*#__PURE__*/_react["default"].createElement("button", {
            onClick: handleClose,
        ...
        box = /*#__PURE__*/_react["default"].createElement("article", {
          role: "dialog",
          tabIndex: "-1",
          ref: function ref(el) {
            _this3.boxRef = el;
          ...
          className: boxClass
        }, closeBtn, /*#__PURE__*/_react["default"].createElement(_Header["default"], {
          title: this.state.title,
          className: this.className('box__header')
        }), /*#__PURE__*/_react["default"].createElement("div", {
          className: this.className('box__body')
        }, this.state.content), /*#__PURE__*/_react["default"].createElement(_Footer["default"], {
